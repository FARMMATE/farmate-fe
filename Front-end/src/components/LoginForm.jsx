...
const LoginForm = () => {
  ...
  return (
    <>
      <div
        className={
          goHome ? "animate-opacity flex flex-col justify-start text-left" : "flex flex-col justify-start text-left"
        }
      >
        <div className="text-xl font-semibold text-left mt-12 mb-20 font-pretendard-r">로그인</div>
        <Input
          id="email"
          name="email"
          type="email"
